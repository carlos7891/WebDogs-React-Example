        ...
        <main>
            <section>
                ...
                <ul className="breedCardContainer">
                    ...
                    <CardRazasPerros nombreRaza='Golden Retriver' imagen={goldenRetriver} megusta='8432' comentario='35' linkstopage='BorderCollieInfoPage'/>
                    <CardRazasPerros nombreRaza='Cavalier King' imagen={CavalierKing} megusta='20543' comentario='65' linkstopage='BorderCollieInfoPage'/>
                    <CardRazasPerros nombreRaza='Bulldog' imagen={bulldog} megusta='7503' comentario='38' linkstopage='BorderCollieInfoPage'/>
                </ul>
            </section>
        </main>
    </div>
